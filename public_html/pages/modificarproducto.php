...
<form action="modificarproducto.php" method="POST">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="" placeholder="" name="idprod" value="<?php if(isset($info_form)){echo $info_form['idproducto'];} ?>" readonly>
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Nombre producto</label>
        <input type="text" class="form-control" id="" placeholder="Nombre" name="nombre" value="<?php if(isset($info_form)){echo $info_form['nombre'];} ?>" required>
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Precio Producto</label>
        <input type="number" class="form-control" id="" placeholder="" name="precio" value="<?php if(isset($info_form)){echo $info_form['precio'];} ?>" required>
    </div>
    ...
    <div class="form-group">
        ...
        <select class="form-control" id="exampleFormControlSelect1" placeholder="" name="tipo" value="" required>
            ...
            <option><?php if(isset($info_form)){echo $info_form['tipo'];} ?></option>
            <option>Otros</option>

...
<form action="modificarproducto.php" method="POST">
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="" placeholder="" name="idprod" value="<?php if (isset($info_form)) {
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="" placeholder="Nombre" name="nombre" value="<?php if (isset($info_form)) {
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="" placeholder="" name="precio" value="<?php if (isset($info_form)) {
